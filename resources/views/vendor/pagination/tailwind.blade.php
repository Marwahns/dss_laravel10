@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between mt-3 mx-3">
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5 ml-6">
                    {!! __('Showing') !!}
                                    ...
                                    @if ($page == $paginator->currentPage())
                                        <span aria-current="page">
                                            <button
                                                ...
                                                <span
                                                    class="text-center flex items-center justify-center h-full">{{ $page }}</span>
                                            </button>
                                        </span>
                                    @else
                                        <a href="{{ $url }}"
